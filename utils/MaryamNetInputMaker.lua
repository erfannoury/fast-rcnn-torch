local MaryamNetInputMaker = torch.class("detection.MaryamNetInputMaker")


local roi = detection.ROI()


function MaryamNetInputMaker:__init()
end

function MaryamNetInputMaker:process(orig_im, bboxes)
...
function MaryamNetInputMaker:_process_image(im)
